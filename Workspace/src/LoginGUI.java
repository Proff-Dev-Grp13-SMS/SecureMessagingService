...
public class LoginGUI implements ActionListener {		//public class that implements actionlistener, which are just actions that are performed when buttons are pressed for example
	...
	public LoginGUI() 
	{
		...
		panel.setLayout(new GridLayout(0, 1));		//fuck knows what this is tbh but it's important apparently
		...
		label.setBounds(50, 50, 50, 50);		//maybe the boundaries / position of the label ? not sure
